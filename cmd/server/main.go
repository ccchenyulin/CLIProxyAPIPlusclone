...
func main() {
	...
	flag.BoolVar(&codeBuddyIntlLogin, "codebuddy-intl-login", false, "Login to CodeBuddy International using browser OAuth flow")
	...
	if vertexImport != "" {
		...
		// Handle CodeBuddy International login
